...
// rfc822Name [1] with a case-insensitive domain (sec. 7.5), a directoryName [4] under the sec. 7.1 canonical
// DN comparison, and every other type by exact DER (fail-closed). `sender` is the parsed [n] GeneralName from
// schema-cmp; `sanNode` is a decoded certificate SAN GeneralName node.
