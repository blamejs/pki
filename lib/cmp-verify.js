 ...
 * sender reaches different values; nor are its choice-of-form rules (the signer identifier form, one
 * key per package, certificate ordering), which are surfaced rather than judged.
 *
 * @opts
