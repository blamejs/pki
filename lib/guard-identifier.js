 ...
 * naming no option; and a falsy one read as absent sends the caller to whatever default the boundary
 * installs, which for a transport is a real network client the caller was trying to replace. Only a
 * genuinely absent option, which reads as undefined, is allowed through. */
