...
//
// The residual, stated rather than papered over: a getter that changes the bag only on a LATER
// read is not caught, since one read is what this can afford to do on the caller's behalf. What
// is closed is the case that reached a shipped verb.
