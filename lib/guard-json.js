...
// The conversion that turns a validated number literal into the value the document is understood to
// carry. A replacement returns something else for text this parser has already checked.
var _Number = require("./guard-intrinsic").Number;
// The gate that refuses a numeric token that overflowed to Infinity. A replacement answering true
// admits it, and the document is understood to carry a value its bytes cannot spell.
