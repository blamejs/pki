...
// BER fallback lets a BER-encoded PFX (the dominant real-world .p12 shape)
// decode far enough to detect; a BER input matching a strict-DER-only format
// still fails typed inside that format's own parse.
var ENTRY = { pemLabel: null, PemError: PemError, ErrorClass: SchemaError, prefix: "schema", what: "input", berFallback: true };
