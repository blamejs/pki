...
var FORMATS = [
  ...
  },
  {
    name: "trustanchor",
    module: trustanchor,
    detect: trustanchor.matches,
    parse: function (input, caps) { return trustanchor.parse(input, caps); },
  },
  {
    name: "ocsp-request",
    module: ocsp,
...
module.exports = {
  ...
  trustanchor: { parse: trustanchor.parse, parseInfo: trustanchor.parseInfo,
    pemDecode: trustanchor.pemDecode, pemEncode: trustanchor.pemEncode },
