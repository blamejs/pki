...
var FORMATS = [
  {
    ...
    // signed-envelope trio and from EncryptedPrivateKeyInfo.
    name: "pkcs8",
    module: pkcs8,
  ...
  },
  {
    ...
    // recognized and surfaced (not decrypted).
    name: "pkcs8-encrypted",
    module: pkcs8,
    detect: pkcs8.matchesEncrypted,
    parse: function (input) { return pkcs8.parseEncrypted(input); },
  },
  {
 ...
 *
 * @example
 *   pki.schema.all();  // → ["pkcs8", "pkcs8-encrypted", "csr", "crl", "x509"]
 */
