...
function client(directoryUrl, opts) {
  ...
  function _finalizeBody(order, o) {
    o = o || {};
    guard.identifier.assertKnownKeys(o, _METHOD_OPTS.finalize, E, "acme/bad-input", "unknown finalize option ");
  ...
  function _poll(kind, url, budget) {
    ...
    try {
      guard.identifier.assertKnownKeys(budget, _METHOD_OPTS.poll, E, "acme/bad-input", "unknown poll option ");
  ...
  function _downloadCertificate(url, opts) {
    ...
    return Promise.resolve().then(function () {
      guard.identifier.assertKnownKeys(opts, _METHOD_OPTS.download, E, "acme/bad-input", "unknown downloadCertificate option ");
  ...
  function _revokeCert(o) {
    ...
    return _promised(function () {
      guard.identifier.assertKnownKeys(o, _METHOD_OPTS.revoke, E, "acme/bad-input", "unknown revokeCert option ");
  ...
  function _keyChangeBody(o) {
    o = o || {};
    guard.identifier.assertKnownKeys(o, _METHOD_OPTS.keyChange, E, "acme/bad-input", "unknown keyChange option ");
  ...
  function _renewalWindow(certDer, o) {
    o = o || {};
    return Promise.resolve().then(function () {
      guard.identifier.assertKnownKeys(o, _METHOD_OPTS.renewalWindow, E, "acme/bad-input", "unknown renewalWindow option ");
