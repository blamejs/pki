...
function _parseLinkValue(raw) {
  ...
  if (LINK_URI_BADCHAR.test(uri) || LINK_URI_BADPCT.test(uri)) throw E("acme/bad-link", "a Link URI-Reference contains a character or percent-escape not permitted by RFC 3986: " + JSON.stringify(raw));
