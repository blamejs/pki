  ...
  (parsedCsr.attributes || []).forEach(function (a) {
    ...
    a.extensions.forEach(function (e) {
      ...
      (dec.names || []).forEach(function (n) {
        if (n.tagNumber === 2) set["dns:" + _lower(_StringI(n.value))] = true;
