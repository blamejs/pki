...
function client(directoryUrl, opts) {
  ...
  function _sendFollowing(method, url, headers, body, redirects) {
    ...
    return transport({ method: method, url: url, headers: reqHeaders, body: body, tls: _tlsFor(url), proxy: budgets.proxy, timeout: budgets.timeout, maxResponseBytes: budgets.maxResponseBytes }).then(function (res) {
      res = res || {};
      var h = {};
