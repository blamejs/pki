...
// insensitively) OR an ext-rel-type (an absolute URI, i.e. a scheme then ':')? Neither matches, e.g., "@".
function _validRelType(t) { return /^[A-Za-z][A-Za-z0-9.-]*$/.test(t) || /^[A-Za-z][A-Za-z0-9+.-]*:/.test(t); }
