...
// hostile (or absent) value can neither hammer the CA nor defer the next check indefinitely.
...
function client(directoryUrl, opts) {
  ...
  function _renewalWindow(certDer, o) {
    ...
    return Promise.resolve().then(function () {
      ...
      return _renewalInfo(certDer).then(function (ri) {
        ...
        var retryAfterSeconds = ri.retryAfterSeconds == null ? null :
