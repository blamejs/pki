...
function _csrIdentifierSet(parsedCsr) {
  ...
  _forEach(_subjectCommonNames(parsedCsr.subject), function (cn) { set["dns:" + _lower(cn)] = true; });
...
function _certIdentifierSet(parsedCert) {
  var set = intrinsic.create(null);
  _forEach(_subjectCommonNames(parsedCert.subject), function (cn) { set["dns:" + _lower(cn)] = true; });
