...
function answer(challenge, params, E) {
  ...
  else if (alg.sess) { parts.push("cnonce=" + _qstr(cnonce)); }   // a -sess A1 folds in the cnonce even with no qop, so the server needs it to recompute A1 (RFC 7616 sec. 3.4.2)
