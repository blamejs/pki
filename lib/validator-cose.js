...
var EC2_CRV_LEN = Object.assign(Object.create(null), { 1: 32, 2: 48, 3: 66 });
var EC2_CRV_OID = Object.assign(Object.create(null), { 1: "prime256v1", 2: "secp384r1", 3: "secp521r1" });
var OKP_CRV = Object.assign(Object.create(null), { 6: { oid: "Ed25519", len: 32 }, 7: { oid: "Ed448", len: 57 } });
var RSA_MIN_MODULUS_BITS = 2048;
var RSA_MAX_EXPONENT_BYTES = 8;
function _modulusBits(n) { return (n.length - 1) * 8 + (32 - Math.clz32(n[0])); }

var ALG_PROFILE = Object.assign(Object.create(null), {
