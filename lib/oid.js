...
var FAMILIES = {
  ...
  // id-aca — RFC 5755 §4.4 attribute-certificate attribute types on the
  // id-pkix 10 arc (authenticationInfo §4.4.1 .. group §4.4.4).
  idAca: { base: [1, 3, 6, 1, 5, 5, 7, 10], of: {
    authenticationInfo: 1, accessIdentity: 2, chargingIdentity: 3, group: 4 } },
