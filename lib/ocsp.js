...
// Every option pki.ocsp.sign reads. `nonce` here is the request nonce this response ECHOES;
// a misspelling emits a response that answers nobody's request, and the client that sent a
// nonce then reads it as unbound.
...
// what binds the response to this request, and a misspelling leaves nonceMatched null -- the
// value that means "the client never asked" -- on a call that did ask.
