...
async function _openContent(parsed, eci, cek, ct) {
  ...
  if (CONTENT_MODE[alg.oid] !== wantMode) {
    throw _err("cms/unsupported-algorithm", "contentEncryptionAlgorithm " + alg.oid + " is not a " + wantMode.toUpperCase() + " cipher, which " + ct + " requires (RFC 5083 sec. 2.1 / RFC 5084 sec. 3)");
  }
