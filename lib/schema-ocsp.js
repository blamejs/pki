...
var TBS_REQUEST = schema.seq([
  schema.optional("version", VERSION, { tag: 0, explicit: true, default: 1, emptyCode: "ocsp/bad-version" }),
  schema.optional("requestorName", schema.any(), { tag: 1, explicit: true, emptyCode: "ocsp/bad-requestor-name" }),
  schema.field("requestList", schema.seqOf(REQUEST, { assert: "sequence", code: "ocsp/bad-request-list", what: "requestList" })),
  schema.trailing([
...
var OCSP_REQUEST = schema.seq([
  ...
  build: function (m) {
    ...
    return {
      ...
      optionalSignature: m.fields.optionalSignature.present ? m.fields.optionalSignature.value.result : null,
    };
  },
});
