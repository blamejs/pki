 ...
 */
var _parseResponse = pkix.makeParser({ pemLabel: "OCSP RESPONSE", PemError: PemError, ErrorClass: OcspError, prefix: "ocsp", what: "OCSP response", topSchema: OCSP_RESPONSE, ns: NS });
...
var parseResponse = guard.parsed.recordingParser("ocspResponse", _parseResponse, OcspError, "ocsp/bad-input", "an OCSP response");
