...
// The rest of the shared static surface. These are here rather than captured per module so that a
// hundred call sites cannot end up with a hundred spellings of the same read, which is what makes a
// sweep like this one incomplete in a way nothing detects.
var _mathMax = Math.max;
var _mathAbs = Math.abs;
var _numberIsNaN = Number.isNaN;
var _jsonParse = JSON.parse;
var _objectEntries = Object.entries;
var _objectValues = Object.values;
...
var _parseInt = globalThis.parseInt;
var _parseFloat = globalThis.parseFloat;
...
module.exports = {
  ...
  abs: _mathAbs,
  isNaN: _numberIsNaN,
  parseJson: _jsonParse,
  entries: _objectEntries,
  values: _objectValues,
  getOwnPropertySymbols: _objectGetOwnPropertySymbols,
