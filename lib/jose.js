 ...
 *
 * The key may come from any WebCrypto implementation; one this toolkit did not create is re-imported
 * through it, since it carries none of the key material this toolkit signs with. A key created
 * non-extractable cannot be re-imported, and is refused with that as the reason.
 *
 * @opts
