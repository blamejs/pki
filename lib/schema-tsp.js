...
function parseToken(input) {
  ...
  try { signed = cms.parse(der); }
    ...
    throw new TspError("tsp/bad-token", "the timeStampToken did not decode as a CMS SignedData: " + ((e && e.message) || _String(e)), e);
  }
  ...
  try { tstInfo = schema.embeddedDer(TST_INFO, encap.eContent, NS, { code: "tsp/bad-der", what: "the encapsulated TSTInfo" }); }
    ...
    if (e instanceof TspError) throw e;
    throw new TspError("tsp/bad-der", "the encapsulated TSTInfo did not decode: " + ((e && e.message) || _String(e)), e);
  }
