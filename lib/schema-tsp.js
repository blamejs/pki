...
var TIME_STAMP_RESP = schema.seq([
  ...
  build: function (m) {
    ...
    // failInfo explains a rejection; a granted response carrying it is contradictory.
    if (granted && status.failInfo) throw NS.E("tsp/unexpected-failinfo", "a granted TimeStampResp must not carry failInfo (RFC 3161 §2.4.2)");
