...
function httpsTransport(defaults) {
  ...
  function _prepare(request) {
    ...
    try { proxyInfo = _validateProxy(request, defaults, E, C, url); }
      ...
      try { typedProxyError = e !== null && typeof e === "object" && !nodeUtil.types.isProxy(e) && e.isPkiError === true; }
      catch (_ie) { /* allow:swallow-unverified reading .isPkiError on a hostile error object can itself throw; treat any such failure as untyped */ }
