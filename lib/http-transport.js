...
function httpsTransport(defaults) {
  ...
  function _prepare(request) {
    ...
    try { proxyInfo = _validateProxy(request, defaults, E, C, url); }
      ...
      try { typedProxyError = e !== null && typeof e === "object" && !nodeUtil.types.isProxy(e) && e instanceof frameworkError.PkiError; }
      catch (_ie) { /* allow:swallow-unverified a subverted Symbol.hasInstance can throw during the instanceof; treat any such failure as untyped */ }
