...
function _copyBytesSameKind(v, ErrorClass, code, label, collect) {
  ...
  var owned = new ArrayBuffer(srcLen);
  _taSet(new Uint8Array(owned), src);
...
function _deep(v, ErrorClass, code, label, cap, depth, collect) {
  ...
  if (surface) {
    ...
    throw _raise(ErrorClass, code, label + ": " + _article(_kindName(v)) + " " + _kindName(v) +
      " carrying its own field " + _stringify(String(carried)) + " cannot be used here -- its " +
  ...
  // never wrote them.
  var out = _create(_getPrototypeOf(v) === null ? null : Object.prototype);
...
function _wasEnumerable(v, name) {
  for (var o = v; o && o !== Object.prototype; o = _getPrototypeOf(o)) {
    var d = _getOwnPropertyDescriptor(o, name);
