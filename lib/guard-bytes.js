...
function _namesToCopy(src, ErrorClass, code, label) {
  return identifier.readableNames(src, function (c, m) { return _raise(ErrorClass, c, m); }, code, label);
}
...
function _copyNamed(src, dst, ErrorClass, code, label, cap, depth, collect) {
  var keys = _namesToCopy(src, ErrorClass, code, label);
