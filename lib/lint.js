...
// An IPv4 dotted-quad or an IPv6 literal (contains a colon) -- a CN validated against an
// iPAddress SAN rather than a dNSName.
function _looksLikeIp(s) { return typeof s === "string" && (/^\d{1,3}(\.\d{1,3}){3}$/.test(s) || s.indexOf(":") !== -1); }
