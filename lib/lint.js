...
var MICROSOFT_RULES = [
  ...
  },
  {
    ...
    message: "an issuing CA certificate must carry a cRLDistributionPoints extension or an authorityInfoAccess naming an OCSP responder",
    ...
    check: function (cert, ctx) {
      ...
      for (var i = 0; i < aia.value.length; i++) {
        if (aia.value[i].accessMethod === ocsp) return null;
      }
      return true;
    },
  },
