...
var CERT_NON_CRITICAL = Object.create(null);
Object.keys(CERT_FIXED_CRITICALITY).forEach(function (o) {
  if (CERT_FIXED_CRITICALITY[o].critical === false) CERT_NON_CRITICAL[o] = false;
});
...
var RFC5280_RULES = [
  ...
  },
  {
    ...
    check: function (cert) {
      var rows = _criticalityRows(cert.extensions, CERT_NON_CRITICAL, "extensions");
      rows.forEach(function (row) { row.context.citation = CERT_FIXED_CRITICALITY[oid.byName(row.context.extension)].citation; });
...
var OCSP_REQUEST_ONLY = Object.create(null);
[["ocspResponse", "RFC 6960 4.4.3"], ["ocspServiceLocator", "RFC 6960 4.4.6"], ["ocspPrefSigAlgs", "RFC 6960 4.4.7"]]
  .forEach(function (r) { OCSP_REQUEST_ONLY[oid.byName(r[0])] = r[1]; });
