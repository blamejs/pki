 ...
 * reason load-bearing: the reason decides which partition an entry belongs in. A malformed
 * issuingDistributionPoint scopes nothing, and the value-syntax row reports it separately. */
function _crlHasReasonScope(crl) {
  ...
  return !idp.malformed && idp.onlySomeReasonsPresent === true;
}
