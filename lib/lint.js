...
function _effective(rule, cert) {
  ...
  return guard.time.isDate(nb) && nb.getTime() >= rule.effectiveDate.getTime();
}
...
var RFC5280_RULES = [
  ...
  },
  {
    ...
    check: function (cert) {
      ...
      return (guard.time.isDate(v.notBefore) && guard.time.isDate(v.notAfter) && v.notBefore.getTime() > v.notAfter.getTime()) ? true : null;
    },
  },
  {
