...
function parseBundle(input) {
  ...
  if (obj.verificationMaterial.certificate && obj.verificationMaterial.x509CertificateChain) {
    throw _err("sigstore/bad-bundle", "verificationMaterial carries both certificate and x509CertificateChain; it is a oneof and exactly one arm may be present");
  }
