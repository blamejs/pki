...
var _stringOf = String;
var _isFiniteNum = isFinite;
...
var _charCodeAt = Function.prototype.call.bind(String.prototype.charCodeAt);
...
function _plainCopy(v, depth, budget) {
  ...
  if (_isArray(v)) {
    ...
    for (i = 0; i < v.length; i++) {
      ...
      /** @internal Written by index rather than through a method the array offers under that name. */
      out[out.length] = el;
    }
    return out;
  }
