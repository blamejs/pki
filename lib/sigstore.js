 ...
 * identity, identityChecked, predicateTypeChecked, integratedTime }` (`valid` is the canonical
 * toolkit-wide verdict alias of `verified`, and `predicateTypeChecked` says whether a pinned
 * `opts.predicateType` was checked). `payload` is the raw verified
