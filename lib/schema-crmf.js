 ...
 */
// Recording, because pki.crmf.verifyPop reaches a verdict from this result: the byte range a
// proof of possession covers, the key that possession is proven for, and the subject the CA will
// issue to are separate properties here, so the record is what binds them to one another.
