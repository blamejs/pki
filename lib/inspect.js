...
// value (rendering "(empty)" for the CRL number or reason). Delegate every raw-value
...
_CMS_SHAPE[oid.byName("authEnvelopedData")] = function (o) { return Array.isArray(o.recipientInfos) && _isObj(o.authEncryptedContentInfo) && Buffer.isBuffer(o.mac); };          // RFC 5083
