...
function _applyCallerRoots(res, opts) {
  var supplied = opts.rootCertificates;
...
function verify(attestationObject, clientDataHash, opts) {
  ...
  var bindingChecked;
  try { bindingChecked = _applyBindings(att.authData, att.authData.credentialPublicKey, opts); }
  catch (e) { return Promise.reject(e); }
  return Promise.resolve().then(function () { return verifier(att, clientDataHash, opts); })
    .then(function (res) {
      ...
      if (opts.metadata === undefined) {
        if (opts.rootCertificates !== undefined) return _applyCallerRoots(res, opts);
        res.anchoredTo = null;
        return res;
      }
      return Promise.resolve().then(function () { return _applyMetadata(res, att, opts); })
        .then(function (out) { out.anchoredTo = "metadata"; return out; }, function (e) {
          ...
          return _applyCallerRoots(res, opts);
        });
    })
