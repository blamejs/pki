 ...
 * @signature pki.webauthn.verify(attestationObject, clientDataHash, opts) -> Promise<{ attestationVerified, fmt, attestationType, trustPath, anchoredTo, aaguid, credentialId, credentialPublicKey, signCount, flags, bindingChecked }>
 * @since 0.2.5
 * @status stable
 ...
 *   for and the path went unchecked.
 *
 * @example
...
function verify(attestationObject, clientDataHash, opts) {
  ...
  return Promise.resolve().then(function () { return verifier(att, clientDataHash, opts); })
    ...
    .then(function (res) {
      ...
      if (opts.metadata !== undefined) { res.anchoredTo = "metadata"; return res; }
