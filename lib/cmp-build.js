...
var KEM_DECAPSULATE = intrinsic.assign(intrinsic.create(null), {
...
function _resolveKemProtection(kemSpec, message) {
  ...
  var wcName = KEM_DECAPSULATE[oid.name(algOid) || algName];
  if (!wcName) {
  ...
  var txid = kemSpec.transactionID != null
    ...
    : _kemBytes(message && message.header ? message.header.transactionID : null,
