...
function _resolveKemProtection(kemSpec, message) {
  ...
  if (typeof len !== "number" || !Number.isInteger(len) || len < 1 || len > constants.LIMITS.CMP_KEM_MAX_KEY_BYTES) {
    throw _err("cmp/bad-input", "opts.kem.len is the derived key size in bytes, 1.." + constants.LIMITS.CMP_KEM_MAX_KEY_BYTES);
  }
