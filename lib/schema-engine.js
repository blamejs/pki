...
function _walkSeq(schema, node, ctx) {
  ...
  // allow:registry-table-inherits-object-prototype -- the record a schema's own check and build callbacks read as m.fields, whose keys are the field names that schema declared rather than anything the input supplies
  var fields = {};
  var idx = 0;
