...
function _snapshotSent(sent) {
  ...
  /** @internal The copy of a shared secret is made here, so a failure after it is made is cleared here
   * too: whatever throws next, the snapshot never leaves an unreferenced copy of a secret behind. */
