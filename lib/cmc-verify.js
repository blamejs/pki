  ...
  return Promise.resolve().then(function () {
    ...
    if (body.cms && body.cms.contentTypeName === "authData") {
      ...
      if (sent.recipient != null) {
        // The frozen RESPONSE BYTES, not the parsed structure: pki.cms.decrypt
        // deliberately refuses a pre-parsed object so nothing can hand it a parse
        // result that skipped DER validation. It re-parses, and the content check
        // below then ties its result back to what was interpreted here.
