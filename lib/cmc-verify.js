 ...
 * a different name through `spec.identityProof.identity` is refused rather than chosen between. Naming
 * a signature and a shared secret together is refused, since a request has one carrier. A `tcr` request is verified against
