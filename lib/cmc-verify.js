  ...
  if (Array.isArray(sent.bodyPartIDs)) {
    ...
    body.statuses.forEach(function (s) {
      (s.bodyList || []).forEach(function (ref) {
        // A bodyPartPath is a reference INTO a nested message; its first element
        // is the body part in THIS one, which is what this set can speak to.
        var id = ref.bodyPartID != null ? ref.bodyPartID
          : (ref.bodyPartPath && ref.bodyPartPath.length ? ref.bodyPartPath[0] : null);
