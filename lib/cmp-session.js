...
// md2/md5/sha1-WithRSASignature set on the OIW Secsig arc, shared with DSA and the SHA-1 hash; and the
// X.509 directory rsa OID (2.5.8.1.1), distinct from PKCS#1 rsaEncryption. A
