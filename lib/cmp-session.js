...
// ML-DSA and SLH-DSA; RSASSA-PSS-with-SHAKE (RFC 8692) on the PKIX arc; every legacy RSA OID standardized
// on the OIW Secsig arc -- md5WithRSA, rsaSignature, shaWithRSAEncryption, and the
// md2/md5/sha1-WithRSASignature set -- which is shared with DES, DSA, and the hashes so no prefix isolates
// it; and the X.509 directory rsa OID (2.5.8.1.1), distinct from PKCS#1 rsaEncryption. A
...
["id-rsa-kem", "id-kem-rsa",
  ...
  "md5WithRSA", "rsaSignature", "shaWithRSAEncryption",
