...
// and RSASSA-PSS-with-SHAKE (RFC 8692) on the PKIX arc. A composite signature naming RSA as one half is
// a composite key, not an RSA one, and lives on that same PKIX arc, so it is outside all of these.
