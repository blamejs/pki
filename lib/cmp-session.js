...
// the ones it has: PKCS#1 (rsaEncryption, PSS, OAEP, every sha*/md*WithRSAEncryption), the TeleTrusT
// rsaSignature arc (RSA with SHA-1 and the RIPEMD family), and the BSI TR-03110 id-TA-RSA arc (EAC
// Terminal Authentication, RSA v1.5/PSS over SHA-1/256/512). Each prefix is the arc a registered member
