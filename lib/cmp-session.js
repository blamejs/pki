 ...
 * the verdict as `deliveredKey`. What binds the grant is then the delivered key rather than a
...
function session(opts) {
  ...
  async function _openDeliveredKey(ckp) {
    ...
    var open = opts.mac != null
      ? { password: opts.mac.secret, authorizedBySharedSecret: opts.trustAnchors == null }
