...
function session(opts) {
  ...
  function _readResumeToken(token) {
     ...
     * A token that names no flavor predates the field and is read as what it can still be checked as. */
    var protection = raw.protection == null ? (isSig ? "signature" : "mac") : raw.protection;
