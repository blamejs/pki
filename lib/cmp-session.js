...
function _boundedPool(base, added) {
  ...
  base.forEach(function (c) { if (Buffer.isBuffer(c)) seen[c.toString("base64")] = 1; });
  added.forEach(function (c) { if (!Buffer.isBuffer(c)) return; var k = c.toString("base64"); if (!seen[k]) { seen[k] = 1; useful.push(c); } });
