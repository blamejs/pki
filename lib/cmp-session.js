...
// arc (RSA with SHA-1 and the RIPEMD family), and the BSI TR-03110 id-TA-RSA arc (EAC Terminal
// Authentication, RSA v1.5/PSS over SHA-1/256/512). Each prefix is the arc a registered member sits
// directly under, read from the registry, so no dotted-decimal literal appears here and pki.oid.register
// cannot move it. The PKCS#1 arc also carries two auxiliary identifiers that are NOT RSA algorithms --
