...
// PKCS#1 rsaEncryption, and sqMod-nWithRSA / mdc2WithRSA on the signatureAlgorithm sub-arc. A composite
// signature naming RSA as one half is a composite key, not an RSA one, and lives on the PKIX arc, so it
// is outside all of these.
