...
function session(opts) {
  ...
  function _snapshotArm(armSpec) {
    ...
    var copy = Object.assign({}, armSpec);
    if (_isRecord(copy.certTemplate)) copy.certTemplate = Object.assign({}, copy.certTemplate);
    ...
    if (_isRecord(copy.pop)) copy.pop = Object.assign({}, copy.pop);
    return copy;
  }
