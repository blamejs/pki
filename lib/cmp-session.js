...
function _certConfHash(certDer) {
  ...
  // A hashless SIGNATURE algorithm (EdDSA / ML-DSA / SLH-DSA): SHA-256 + an explicit hashAlg. Checked FIRST
  // by OID so a coincidental name (e.g. "id-slh-dsa-sha2-...") is never read as a hash-conveying algorithm.
