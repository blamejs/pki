...
function verifyOcspResponse(parsedResponse, cert, issuerCert, time, opts) {
  ...
  catch (_e) { return Promise.resolve({ status: "unknown", responderAuthorized: false, signatureValid: false, matched: false, reason: "the issuer public key could not be read to recompute the OCSP CertID" }); }
