...
// SLH-DSA (FIPS 205) — params absent. The twelve pure sets; the RFC 9909 §3
// OID name maps to the WebCrypto set name by id-slh-dsa-<set> -> SLH-DSA-<SET>
// (the webcrypto SLH_DSA_NODE keys). One-shot verify like ML-DSA / EdDSA.
["sha2-128s", "sha2-128f", "sha2-192s", "sha2-192f", "sha2-256s", "sha2-256f",
 "shake-128s", "shake-128f", "shake-192s", "shake-192f", "shake-256s", "shake-256f"
  ...
  _sig("id-slh-dsa-" + set, { name: wc }, { name: wc }, "absent");
});
