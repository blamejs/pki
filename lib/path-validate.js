...
module.exports = {
  ...
  /** @internal Shared with pki.lint so the linter and the path validator read an
   * IssuingDistributionPoint through ONE decoder and cannot disagree about what a well-formed one
   * is. It reports a fault as `malformed` rather than throwing. */
  decodeIdp: decodeIdp,
};
