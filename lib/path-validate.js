...
function toAnchor(entry, verb) {
  ...
  if (isTuple) {
    ...
    // name was already read once into nameRaw at the discriminator; reuse it so name is read EXACTLY ONCE
    // (like publicKey and algorithm). purposes and distrustAfter are read once each here.
    meta.name = nameRaw;
    var mi, mf;
