...
function resolveRsaPss(paramsBytes) {
  ...
  if (paramsBytes) {
    ...
    // Only an ABSENT parameters field uses the defaults; a present field that
    // is not an RSASSA-PSS-params SEQUENCE (a DER NULL, an INTEGER) is malformed
    // and must fail closed, not verify under the SHA-1/salt-20 defaults.
