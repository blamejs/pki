...
function _shbsVerify(spkiBytes, sigBytes, message) {
  ...
  try {
    ...
    if (!guard.crypto.isOctetAligned(bits)) {
      return { ok: false, code: "path/bad-signature",
    ...
    rawKey = bits.bytes;
  } catch (e) { return { ok: false, code: pathCode(e, "path/bad-signature"), error: e }; }
  try {
    return { ok: _shbsHssVerify(rawKey, message, sigBytes) === true };
  } catch (e) { return { ok: false, code: pathCode(e, "path/bad-signature"), error: e }; }
}
