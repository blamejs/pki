...
function _verifyOcspParsed(parsedResponse, cert, issuerCert, time, opts) {
  ...
  function unbound(reason) { return { status: "unknown", responderAuthorized: false, signatureValid: false, matched: false, thisUpdate: null, nextUpdate: null, reason: reason }; }
  var boundName;
