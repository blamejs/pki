...
function _hasPurposeScopedMetadata(ta) {
  ...
  return guard.list.anyMatches(["distrustAfter", "purposes"], function (k) {
    ...
    // evade this "the anchor carries purpose-scoped metadata -> require checkPurpose" gate. The normalized anchor
    // already materializes these maps to plain enumerable data; this stays correct for any map reaching here.
