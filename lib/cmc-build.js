...
// One level per signer descriptor -- enough that the fields cms.sign reads later
// (key, cert, spki, keyIdentifier) are the ones this call was made with. The
// values themselves stay the caller's: a CryptoKey handle is meant to be shared,
// and a certificate buffer is read before this returns.
