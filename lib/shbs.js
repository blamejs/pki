...
function _lmsVerify(pubBytes, message, sigBytes) {
  ...
  // public key commits to cannot verify against it. RFC 8554 Algorithm 6a step 2c
  // returns INVALID (a verification FAILURE, false), not a structural error -- the
  // signature is well-formed for its own typecode, it just does not match this key.
