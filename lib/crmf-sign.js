...
function _assertEnclosedKeyMatches(privateKeyDer, templateSpki) {
  return Promise.resolve()
    ...
    .then(function (derivedSpki) {
       ...
       * the one form rather than read as a different key. The group is NOT measured: this arm sends a
       * private key to be archived and agrees nothing, so the floors the agreement needs would refuse
       * a legacy key this arm exists to enroll. */
