...
function _verifyOne(msg) {
  ...
  function settle(extra) { var v = Object.assign({}, base, extra); v.valid = v.verified === true; return Promise.resolve(v); }   // `valid` is the canonical toolkit-wide alias of this message's `verified`
