...
function _assertDhGroup(p, g, y, q, j, forAgreement, what) {
  /** @internal The domain parameters are bounded by the key module's own test; the public value,
   * which that module never sees, is bounded here to the same width before it is compared. */
  if (y !== null && y >= _DH_MAX) {
