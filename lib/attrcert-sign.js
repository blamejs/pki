...
// replaceable properties to answer one thing, and either answering true admits a name the table
// never carried -- here, an unrecognized critical extension counted as one this profile supports.
...
function _verify(ac, issuer, opts) {
  ...
  var result = {
    ...
    valid: false,                  // canonical toolkit-wide verdict alias, tracks `verified`
    verified: false,
    reason: undefined,
  };
