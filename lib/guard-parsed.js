...
function isCert(o) {
  return !!o && typeof o === "object" &&
    ...
    _isArray(o.extensions) && o.extensions.every(_isExtensionEntry);
}
...
function isCrl(o) {
  return !!o && typeof o === "object" &&
    ...
    _isArray(o.crlExtensions) && o.crlExtensions.every(_isCrlExtensionEntry) &&
    _isArray(o.revokedCertificates) && o.revokedCertificates.every(function (e) {
      return !!e && typeof e.serialNumber === "bigint" &&
        typeof e.serialNumberHex === "string" &&
        time.isDate(e.revocationDate) &&
        _isArray(e.crlEntryExtensions) && e.crlEntryExtensions.every(_isCrlExtensionEntry);
    });
}
...
function recordingParser(kind, parse, ErrorClass, code, label) {
  return function (input) {
    ...
    if (out && typeof out === "object") {
      PROVENANCE.set(out, { kind: kind, source: isText ? snap : _bufferFrom(snap),
        shape: _shapeOf(out) });
    }
    return out;
  };
