...
var LIMITS = {
  ...
  // SCEP transactionID length ceiling (RFC 8894 sec. 3.2.1.1). The RFC sets no
  // length; a real transaction id is a short hash or key fingerprint, so the
  // builder caps the caller-supplied PrintableString here rather than emitting
