...
// material (an RSA-131072 modulus) and 16 bytes covers any real OID arc
// (a 128-bit sub-identifier); anything larger is refused as hostile.
var LIMITS = {
  DER_MAX_BYTES: BYTES.mib(16),
  DER_MAX_DEPTH: 64,
  PEM_MAX_BYTES: BYTES.mib(16),
  DER_MAX_INTEGER_BYTES: BYTES.kib(16),
  OID_MAX_SUBIDENTIFIER_BYTES: 16,
};
