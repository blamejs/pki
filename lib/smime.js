...
// Resent-*, Comments, Keywords, and optional / X-* fields) is legitimately repeatable in a real message. A Set
// (not a plain object) so an attacker-chosen field name like "constructor" / "__proto__" cannot match an
// inherited Object.prototype member and false-trip the singleton reject.
var RFC5322_SINGLETON = new Set(["date", "from", "sender", "reply-to", "to", "cc", "bcc", "message-id", "in-reply-to", "references", "subject"]);
