...
// RFC 5652 sec. 5.3 / sec. 9.3 -- when content-binding attributes are present, the
// content-type attribute value MUST equal the eContentType (a cross-field
// consistency both are parsed here). Shared by SignedData signedAttrs and
