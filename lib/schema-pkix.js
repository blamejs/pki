...
function certExtensionDecoders(ns) {
  ...
  function authorityKeyIdentifier(buf) {
    ...
    var out = intrinsic.assign(intrinsic.create(null), { keyIdentifier: null, authorityCertIssuer: null, authorityCertSerialNumber: null });
    var lastTag = -1;
    _forEach(kids, function (k) {
  ...
  function crlDistributionPoints(buf) {
    ...
    return _map(kids, function (dp) {
      ...
      var out = intrinsic.assign(intrinsic.create(null), { distributionPoint: null, reasons: null, cRLIssuer: null });
      var lastTag = -1;
