...
function certExtensionDecoders(ns) {
  ...
  function keyUsage(buf) {
    ...
    // allow:registry-table-inherits-object-prototype -- the decoded KeyUsage record, whose keys are the fixed KU_BITS names the schema declares rather than anything the certificate supplies
    var out = {};
  ...
  function authorityKeyIdentifier(buf) {
    ...
    // allow:registry-table-inherits-object-prototype -- the decoded AuthorityKeyIdentifier record, read by the three field names the schema declares rather than by anything the certificate supplies
  ...
  function crlDistributionPoints(buf) {
    ...
    return _map(kids, function (dp) {
      ...
      // allow:registry-table-inherits-object-prototype -- the decoded DistributionPoint record, read by the three field names the schema declares rather than by anything the certificate supplies
