...
function crlExtensionDecoders(ns) {
  ...
  byScope.crl[O("cRLNumber")] = function (buf, ctx) {
    var v = asn1.read.integer(decodeNested(buf, ctx, "a cRLNumber extension value"));
    if (v < 0n) throw new Error("cRLNumber must be non-negative (INTEGER 0..MAX)");
    return v;
  };
