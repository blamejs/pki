...
function certExtensionDecoders(ns) {
  ...
  // [MS-WCCE] szOID-CERTSRV_PREVIOUS_CERT_HASH -- OCTET STRING of the prior CA cert's digest
  // (algorithm not encoded, so no fixed-length gate). Same shape as subjectKeyIdentifier.
