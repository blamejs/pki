...
function certExtensionDecoders(ns) {
  ...
  // which owns the inner peel + the bounded TLS decode and throws its own `ct/*`
  // codes; structure is decoded, the signature stays raw and unverified.
  function sctList(buf) { return ct.parseSctList(buf); }
  ...
  function precertPoison(buf) {
    var C = ns.prefix + "/bad-precert-poison";
