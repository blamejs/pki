...
/** @internal The table keyed by dotted OID through the registry the caller passes, since this
 *  module takes its registry as a parameter rather than requiring it. */
function certFixedCriticality(oidRegistry) {
  var table = _create(null);
  _forEach(CERT_FIXED_CRITICALITY_ROWS, function (r) {
