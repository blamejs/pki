...
function _resolveContentDigests(parsed, streamSource) {
  if (streamSource == null) return Promise.resolve(null);
  var names = [], seen = {};
...
function _verify(input, opts) {
  ...
  return _resolveContentDigests(parsed, streamSource).then(function (digestByName) {
