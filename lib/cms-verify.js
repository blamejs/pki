...
function _verifyOne(si, content, eContentType, parsedCerts) {
  ...
  // With signed attributes present, an ML-DSA digestAlgorithm (id-sha512 / id-shake256) MUST have
  // its parameters OMITTED -- stricter than the generic absent-or-NULL rule above -- so a present
  // DER NULL is outside the ML-DSA profile and fails closed (RFC 9882 sec. 3.3).
