 ...
 *
 * The key may come from any WebCrypto implementation. Neither implementation can read the other's key
 * material, so a key this toolkit did not create is exported through the one that owns it. A key created
 * non-extractable is reachable by neither, and is refused with that as the reason.
 *
 * @opts
