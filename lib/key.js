...
async function correspondsTo(privateKey, spkiDer) {
  ...
  /** @internal The family question is symmetric: a composite half on either side against a half of
   * another family is not a pair, decided from the identifiers before the runtime is asked to read a
   * structure it cannot. */
  ...
  var publicOid = _algorithmOidAt(_bufferFrom(spkiDer), 0);
