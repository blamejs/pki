...
var KNOWN_SPEC_KEYS = Object.assign(Object.create(null), { subject: 1, subjectPublicKey: 1, extensionRequest: 1, challengePassword: 1, attributes: 1 });
/** @internal The three this verb reads, which are the three `pki.x509.sign` reads. A name outside
 * them was accepted and dropped, so asking for PEM and misspelling the option returned DER and
 * reported nothing. */
var KNOWN_SIGN_OPTS = Object.assign(Object.create(null), { digestAlgorithm: 1, pem: 1, pss: 1 });
var b = asn1.build;
 ...
 * subjectKeyIdentifier / qcStatements, or an array of pre-encoded Extension DER) and
 * `challengePassword`. `key` (or
