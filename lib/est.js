...
/** @internal Refused at the door, before any payload work, and again where the value is used. */
function _assertTransport(transport) {
  guard.identifier.assertCallable(transport, E, "est/bad-input", "opts.transport", TRANSPORT_SHAPE);
}
