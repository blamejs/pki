...
function _client(op, method, baseUrl, body, headers, opts, proxySnap, onAttempt) {
  var base;
...
function fullcmc(baseUrl, request, opts) {
  ...
  try {
    ...
    return _client("fullcmc", "POST", baseUrl, body,
      { accept: "application/pkcs7-mime", "content-type": "application/pkcs7-mime; smime-type=CMC-request" }, opts, proxySnap)
...
function _enrollBound(op, baseUrl, builder, opts, proxySnap) {
  ...
  return _client(op, "POST", baseUrl, hopBody, ENROLL_HEADERS, opts, proxySnap, hopBody)
    .then(function (res) {
...
function _enroll(op, baseUrl, csrInput, opts, proxySnap) {
  ...
  return _client(op, "POST", baseUrl, body, ENROLL_HEADERS, opts, proxySnap)
...
function cacerts(baseUrl, opts) {
  ...
  return Promise.resolve().then(function () {
    ...
    return _client("cacerts", "GET", baseUrl, null, { accept: "application/pkcs7-mime" }, opts, proxySnap);
...
function serverkeygen(baseUrl, csrInput, opts) {
  ...
  return Promise.resolve().then(function () {
    ...
    return _client("serverkeygen", "POST", baseUrl, transferEncode(csrDer), { accept: "multipart/mixed", "content-type": "application/pkcs10" }, opts, proxySnap)
...
function csrattrs(baseUrl, opts) {
  ...
  return Promise.resolve().then(function () {
    ...
    return _client("csrattrs", "GET", baseUrl, null, { accept: "application/csrattrs" }, opts, proxySnap);
