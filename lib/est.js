...
function _enrollBound(op, baseUrl, builder, opts, proxySnap) {
  ...
  var captured = { spki: null, error: null };
  function boundBody(channel) {
    ...
    return guard.async.deferred(function () { return builder(channel); })
      ...
      .then(function (built) {
        ...
        captured.spki = csr.parse(der).subjectPublicKeyInfo;
        return transferEncode(der);
      })
      .then(null, function (e) { captured.error = e; throw e; });
  }
  return _client(op, "POST", baseUrl, boundBody, ENROLL_HEADERS, opts, proxySnap)
    .then(function (res) { return _certsResult(op, res, opts, captured.spki); },
      function (e) { throw _causedBy(e, captured.error) ? captured.error : e; });
}
