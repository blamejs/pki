...
function _sign(spec, issuer, opts) {
  ...
  if (issuerPathLen != null) {
    ...
    if (issued.cA) {
      if (issuerPathLen < 1) throw _err("x509/bad-input", "the issuer certificate pathLenConstraint (0) forbids issuing a CA certificate below it (RFC 5280 sec. 4.2.1.9)");
