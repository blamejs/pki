...
function _encodeName(spec) {
  if (Buffer.isBuffer(spec)) return spec;
...
function _buildExtensions(extSpec, ctx) {
  ...
  if (Array.isArray(extSpec)) return extSpec.map(function (e, i) { var der = _reqDer(e, "extension"); _assertValidExtension(der, i); return b.raw(der); });
