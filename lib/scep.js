 ...
 *   request pkiMessage (PKCSReq, RenewalReq, CertPoll, GetCert, or GetCRL);
 *   `pki.scep.parse` verifies the
 ...
 *
 * @card
 *   Build and read SCEP (RFC 8894) client messages: a PKCSReq, RenewalReq,
 *   CertPoll, GetCert, or GetCRL request wrapped in the signed-over-encrypted CMS
 *   layering, and any of those or a CertRep parsed back to its verified transaction
 *   attributes and decrypted messageData.
 */
 ...
 *
 * @opts
 *   - `messageType` -- "PKCSReq" | "RenewalReq" | "CertPoll" | "GetCert" | "GetCRL".
