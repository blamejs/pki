...
// C509 / X.509 named-curve OID name -> the WebCrypto namedCurve validator.sig uses.
var WEBCRYPTO_CURVE = { prime256v1: "P-256", secp384r1: "P-384", secp521r1: "P-521" };
...
_derToType3 = function (input) {
  ...
  if (!coordLen) throw _err("c509/non-invertible", "unsupported EC curve " + (curve || curveOid));
  ...
  return {
    ...
    signatureValue: validator.sig.ecdsaDerToP1363(c.signatureValue.bytes, WEBCRYPTO_CURVE[curve], C509Error, "c509/bad-signature"),
  };
};
