...
function run() {
  check("all() lists the registered formats in detection order", JSON.stringify(pki.schema.all()) === JSON.stringify(["cms", "ocsp-request", "ocsp-response", "pkcs8", "csr", "crl", "x509"]));
