...
async function run() {
  ...
  check("DG-p-unterminated. an unterminated quoted value is handled, and the missing nonce fails closed", codeOf(function () { httpDigest.parseChallenge('Digest realm="unterminated', E, "est/digest-bad-challenge"); }) === "est/digest-bad-challenge");
